...
public class Graph {
    ...
    public void contractEdge(Edge edge_to_contract) {
        ...
        ArrayList<Edge> oldEdge = new ArrayList<>(edges);
        for (Edge e: oldEdge) {
        	if ((e.node_2 == v && e.node_1==u) || (e.node_2 == u && e.node_1 == v)) {
        		//looping edge, do nothing
        		edges.remove(e);
        	} else if (e.node_1 == v || e.node_1 == u) {
        		newEdges.add(new Edge(w, e.node_2));
        		edges.remove(e);
        	} else if (e.node_2 == v || e.node_2 == u) {
        		newEdges.add(new Edge(e.node_1, w));
        		edges.remove(e);
        	}
        }
