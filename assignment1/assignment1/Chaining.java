...
public class Chaining {
    ...
    public int insertKey(int key){
        //TODO: implement this and change the return statement
	//get the hash value from the formula and insert the key into the correct place        
	int hash = chain(key);
	Table.get(hash).add(key);
    	//get the size of the table, the size of the table minus one is the number of collisions
	// you could have.
	if (Table.get(hash).size()>=1) {
		// the size of the table is the number of collisions
